...
public class JsoupHttpRequest {
    ...
    public static Connection.Response sendHttpRequest(String url, String cookie, Map<String, Object> dataMap) throws IOException {
        ...
        Connection.Response response = connection.ignoreContentType(true).timeout(3000).execute();
        return response;
    }
    ...
    public static void main(String[] args){
        try {
            ...
            Connection.Response response = sendHttpRequest(SystemConfigParseUtil.getProperty("HIS_PATIENT_URL"),"",map);
