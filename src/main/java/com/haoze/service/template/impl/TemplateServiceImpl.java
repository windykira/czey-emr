...
public class TemplateServiceImpl implements TemplateService {
    ...
    public ResponseResult save(TemplateEntity entity,String xml) {
        ...
        try {
            ...
            MyFileUtil.writeFile(SystemConfigParseUtil.getProperty("FILE_PATH")+"template\\",id+code+".xml",xml);
    ...
    public ResponseResult update(TemplateEntity entity,String xml) {
        ...
        try {
            ...
            MyFileUtil.rewriteFile(SystemConfigParseUtil.getProperty("FILE_PATH")+path,xml);
            return ResponseResult.success();
        }catch (Exception e){
            e.printStackTrace();
            TransactionAspectSupport.currentTransactionStatus().setRollbackOnly();
